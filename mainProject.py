...
def is_valid(customer_account_number):
    '''To check the validity of customer account number'''
    try:
...
def check_date(date):
    '''to check the number of days in months'''
...
def append_data(database_path, data):
    '''To write the data into their respective database'''
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to AAPNO BANK")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#E0BBE4")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#FFDFD3", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="#957DAD", disabledforeground="#a3a3a3",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#FFDFD3", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#FEC8D8")
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#957DAD",
                                foreground="#00254a",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#957DAD",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        window.configure(background="#EED8F3")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#DBF1E6")
        ...
        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#91ADB4", borderwidth="0", disabledforeground="#a3a3a3",
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#91ADB4", foreground="#fffffe", borderwidth="0",
...
class customerMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#E3D4B3")
        ...
        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ececec",
                                 activeforeground="#000000", background="#91ADB4", borderwidth="0",
